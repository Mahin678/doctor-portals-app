					...
					<div className="col-sm-12 col-md-12 col-lg-6   ">
						<div className="pt-5">
							...
							<p style={{ lineHeight: '30px' }}>
								...
								Aliquid, maiores? Nulla nisi blanditiis delectus
								suscipit voluptatum iusto ullam necessitatibus sunt.
								Lorem ipsum dolor sit amet, consectetur adipisicing
								elit. Mollitia inventore laboriosam ipsum eum commodi
								doloremque blanditiis dignissimos voluptatibus labore
								sequi? Lorem ipsum dolor sit, amet consectetur
								adipisicing elit. Nobis, impedit.
							</p>
							<button className="btn custom-btn mt-5 ">
								Learn more
							</button>
						</div>
					</div>
